			...
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
                                            ...
                                            <h2><b>Rohan Mahendra Chaudhari</b></h2><br>
                                            
                                            <h4 class="font-yellow">Hello</h4>
                                                <b class="text-muted">Hello World</b>
                                                
                                            <br><br>
						<ul class="social-icons">
							<li><a href="https://github.com/Rohanchaudhari98/Web-Technology-2-Project.git" target="_blank">
                                                                <i class="fa fa-github"></i></a></li>
							<li><a href="https://www.linkedin.com/in/rohanc/" target="_blank">
                                                                <i class="fa fa-linkedin"></i></a></li>
							<li><a href="https://web.facebook.com/rohanc/" target="_blank">
                ...
                <a class="portfolio-item" href="https://www.nimun.com.pk" target="_blank">
                  <span class="caption">
                    <span class="caption-content">
                      <h2>PESMUN'19</h2>
                      <p class="mb-0 text-white">Official website for the PES University Model<br>
                      United Nations (PESMUN'19)</p>
                    </span>
                  </span>
