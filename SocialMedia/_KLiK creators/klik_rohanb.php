				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="info">
							...
							<div class="right-area">
								<h5>123456789</h5>
                                                                <h6>I saw this number in his notebook</h6>
							</div><!-- right-area -->
						</div><!-- info -->
					</div><!-- col-sm-4 -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
                                            <div class="profile-img"><img src="img/rohanb.JPG" alt=""></div>
                                            <h2><b>Rohan B Sahu</b></h2><br>
                                            
                                            <h4 class="font-yellow">What goes up, must come down</h4>
                                                <b class="text-muted">Hello</b>
