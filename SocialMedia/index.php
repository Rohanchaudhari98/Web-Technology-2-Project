...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <img src='img/logo.gif' id='loader-logo'>
            <div class="loader">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="blog-tab" data-toggle="tab" href="blogs.php" role="tab" 
                                 aria-controls="blog" aria-selected="false">Recent Blogs</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="poll-tab" data-toggle="tab" href="polls.php" role="tab" 
                                 aria-controls="poll" aria-selected="false">Recent Polls</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="event-tab" data-toggle="tab" href="events.php" role="tab" 
