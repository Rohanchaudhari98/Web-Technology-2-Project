    ...
    <?php
        ...
        if (isset($_POST['contact_submit'])){
            ...
            try {
                ...
                echo '<h4 class="error">Message Sent'
                        .'</h4>';
			...
			<form class="contact100-form validate-form" method="post" action="">
				...
				<div class="container-contact100-form-btn">
                                    ...
                                    <input type="submit" class="contact100-form-btn" 
                                           name="contact_submit" href="index.php" value="Send Message">
			...
			<div class="contact100-more flex-col-c-m" style="background-image: url('img/contact.jpg');">
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							github.com/rohanc/KLiK--PHP-coded-Social-Media-Website
						</span>
					</div>
				</div>
				...
				<div class="dis-flex size1 p-b-47">
					...
					<div class="flex-col size2">
						...
						<span class="txt3">
							socialnetworkwebtech@gmail.com
						</span>
					</div>
				</div>
                            <?php
